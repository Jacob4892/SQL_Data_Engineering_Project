# Data Analysis w/ SQL: Job Market Analytics
...
1. [`01_top_demanded_skills.sql`](01_top_skills_indemand.sql) – demand analysis with multi-table joins  
...
1. **[Top Demanded Skills](01_top_skills_indemand.sql)** – Identifies the 10 most in-demand skills for remote data engineer positions
